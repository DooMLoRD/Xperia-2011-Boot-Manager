...
*/
    ...
    for (;;) {
		...
		ensure_path_mounted("/system");
		__system("/sbin/bootcustkernel");
		// if the command fails then the show the following
		ui_print("There was a problem booting custom kernel.\n");
		ui_print("Please contact your ROM/Kernel provider.\n");
		ensure_path_unmounted("/system");
                break;

            case ITEM_APPLY_SDCARD:
		/* BOOTING xRecovery */
		__system("/sbin/bootxrec");
		// if the command fails then the show the following
		ui_print("There was a problem booting xRecovery.\n");
		...
		/* Custom Kernel Menu */
            ...
            case ITEM_NANDROID:
		/* Continue booting into OS */
                exitboot=1;
                return;

            case ITEM_PARTITION:
		/* BOOTING CWM5 Recovery */
		__system("/sbin/bootcwm5");
		// if the command fails then the show the following
		ui_print("There was a problem booting CWM5 Recovery.\n");
		ui_print("Please contact DooMLoRD with this problem.\n");
                break;

            case ITEM_ADVANCED:
		/* BOOTING CWM4 Recovery */
		__system("/sbin/bootcwm4");
		// if the command fails then the show the following
		ui_print("There was a problem booting CWM4 Recovery.\n");
		ui_print("Please contact DooMLoRD with this problem.\n");
                break;
...
main(int argc, char **argv) {
    ...
    if (toggle_secure_fs) {
        ...
        ui_set_show_text(1);
        ui_set_background(BACKGROUND_ICON_BOOTMENU_BGK);
