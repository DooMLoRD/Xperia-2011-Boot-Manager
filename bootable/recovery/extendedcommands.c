...
void show_choose_zip_menu()
{
    ...
    static char* headers[] = {  "Choose a Custom Kernel package to boot",
                                "",
                                NULL
    };

    char* file = choose_file_menu("/sdcard/kernels/", ".zip", headers);
    if (file == NULL)
        return;
